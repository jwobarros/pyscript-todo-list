...
task_list = Element("todo")
new_task_content = Element("new-task")
...
def add_task(*ags, **kws):
    ...
    task_html_content = task_html.select("label")
...
new_task_content.element.onkeypress = add_task_enter_event
Element("new-task-btn").element.onclick = add_task_event